...
export const BSPTest = new Token(
  ChainId.RINKEBY,
...
export const BSPTestMatic = new Token(
  ChainId.RINKEBY,
...
export const BSPMatic = new Token(
  ChainId.RINKEBY,
...
export const BSPxDai = new Token(
  ChainId.RINKEBY,
...
export const BSPFantom = new Token(
  ChainId.RINKEBY,
  '0x8b8407c6184f1f0fd1082e83d6a3b8349caced12',
  8,
  'BSP',
...
export const DEFAULT_TOKENS = [
  ...
  BSPBSC,
  BSPFantom,
  // new Token(ChainId.RINKEBY, '0x44c1a9d7d1f932b4c2811a70edffdd6ae2eb60e6', 8, 'BSP', 'Circuits of Value'),
