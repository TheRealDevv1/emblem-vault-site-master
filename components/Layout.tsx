...
import { BSP, BSPTest, BSPTestMatic, BSPMatic, BSPxDai, BSPBSC, BSPFantom, DEFAULT_TOKENS } from '../tokens'
      ...
      >
        ...
        >
          {typeof account !== 'string' ? (
            ...
            [
              chainId == 1 ? BSP : 
              chainId == 80001 ? BSPTestMatic : 
              chainId == 137 ? BSPMatic : 
              chainId == 100? BSPxDai : 
              chainId == 56 ? BSPBSC :
              chainId == 250 ? BSPFantom :
              BSPTest,
              firstToken ? (firstToken.symbol != 'BSP' ? firstToken : null) : null,
              secondToken ? (secondToken.symbol != 'BSP' ? secondToken : null) : null,
            ]
              .filter((token) => token)
        ...
        >
          {/* <Popover usePortal>
            ...
            <PopoverContent zIndex={4} width="5000px">
              <PopoverArrow />
              <PopoverCloseButton />
              <PopoverBody><Text fontSize="xs">Emblem Vault is experimental. Before purchasing $BSP or $FUEL tokens, you must ensure that the nature, complexity and risks inherent in the trading of cryptocurrency are suitable for your objectives in light of your circumstances and financial position. Emblem, Emblem Vault, $BSP, and/or $FUEL shall be under no obligation to purchase or to broker the purchase back from you of your cryptocurrency in circumstances where there is no viable market for the purchase of the same. The products and services presented on this website may only be purchased in jurisdictions in which their marketing and distribution are authorized. Using or Creating Vaults is done at your own risk.</Text></PopoverBody>
            </PopoverContent>
          </Popover> */}
        </Stack>
        ...
        >
          <Button
            ...
            // }}
            onClick={()=>{initializeTransak(account, 'BSP')}}
          >
            Buy $BSP
          </Button>
        </Stack>
